    ...
    extend: {
      ...
      keyframes: {
        ...
        "rotate-3d-slow": {
          ...
          "25%": { transform: "rotateX(5deg) rotateY(10deg) rotateZ(2deg)" },
          "50%": { transform: "rotateX(0deg) rotateY(15deg) rotateZ(0deg)" },
      ...
      animation: {
        ...
        "rotate-3d": "rotate-3d-slow 8s ease-in-out infinite",
        "rotate-y": "rotate-y-slow 6s ease-in-out infinite",
        "rotate-x": "rotate-x-slow 7s ease-in-out infinite",
        "float-rotate": "float-rotate 8s ease-in-out infinite",
        "pulse-3d": "pulse-3d 5s ease-in-out infinite",
      },
      backgroundImage: {
